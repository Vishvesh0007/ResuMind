            ...
            <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col gap-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
                    <div>
                        ...
                        <h1 className="text-3xl font-extrabold text-white mt-2">Project User Analytics</h1>
                        <p className="text-slate-400 text-sm mt-1">
                            Monitor registered users, login sessions, and platform usage in real-time.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={isFetching}
                        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-200 text-sm font-medium transition-all cursor-pointer disabled:opacity-50"
                    >
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl overflow-hidden">
                    ...
                    {isFetching && userList.length === 0 ? (
                        <div className="p-12 text-center text-slate-400 flex flex-col items-center gap-3">
                            ...
                            <p>Loading user activity records...</p>
                        </div>
                    ) : userList.length === 0 ? (
                        <div className="p-12 text-center text-slate-400">
                            <p className="text-base font-medium text-slate-300">No User Logins Recorded Yet</p>
                            <p className="text-sm text-slate-500 mt-1">
                                User login events will automatically appear here once users sign in via Puter.js.
                            </p>
                        </div>
                    ) : (
